...
export default function VendorFavorite() {
    ...
    const handleAddToCart = async (product) => {
        ...
        try {
            ...
            if (cartSnapshot.empty) {
                const cartId = `${user.uid}_${product.productId}`;
                    ...
                    {favorites.map((fav) => (
                        ...
                        >
                            <button
                                ...
                                className="absolute cursor-pointer top-3 right-3 p-2 bg-white border border-red-100 rounded-full hover:bg-red-100 text-red-500 transition z-10"
                            ...
                            <button
                                ...
                                className="mt-4 cursor-pointer bg-[#A78074] text-white px-4 py-2 rounded hover:bg-white hover:text-[#A78074] border border-[#A78074] transition"
                            >
                                Add to Cart
                            </button>
                            </div>
